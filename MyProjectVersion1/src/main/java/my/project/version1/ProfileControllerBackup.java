...
//@Controller
public class ProfileControllerBackup {
/*
	@Autowired
	...
	@ResponseBody
	public ProfileDto2 Profileinput1(HttpSession session ,Locale locale, Model model, ProfileDto2 profiledto) throws IOException 
	{	
	...
	@ResponseBody
	public ProfileDto2 Profileinput2(HttpSession session ,Locale locale, Model model, ProfileDto2 profiledto) throws IOException 
	{	
		UserDto userdto = (UserDto)session.getAttribute("obj"); // 로그인시 obj이름으로 세션생성했음
		profiledto.setUserid(userdto.getUserid()); // 프로필 입력 아이디 셋팅
	...
	@ResponseBody
	public ProfileDto2 Profileinput3(HttpSession session ,Locale locale, Model model, ProfileDto2 profiledto) throws IOException 
	{	
		UserDto userdto = (UserDto)session.getAttribute("obj"); // 로그인시 obj이름으로 세션생성했음
		profiledto.setUserid(userdto.getUserid()); // 프로필 입력 아이디 셋팅
	...
	@ResponseBody
	public ProfileDto2 Profileinput4(HttpSession session ,Locale locale, Model model, ProfileDto2 profiledto) throws IOException 
	{	
		UserDto userdto = (UserDto)session.getAttribute("obj"); // 로그인시 obj이름으로 세션생성했음
		profiledto.setUserid(userdto.getUserid()); // 프로필 입력 아이디 셋팅
	...
	@ResponseBody
	public ProfileDto2 Profileinput5(HttpSession session ,Locale locale, Model model, ProfileDto2 profiledto) throws IOException 
	{	
		UserDto userdto = (UserDto)session.getAttribute("obj"); // 로그인시 obj이름으로 세션생성했음
		profiledto.setUserid(userdto.getUserid()); // 프로필 입력 아이디 셋팅
	...
	@ResponseBody
	public ProfileDto2 Profileinput6(HttpSession session ,Locale locale, Model model, ProfileDto2 profiledto) throws IOException 
	{	
		UserDto userdto = (UserDto)session.getAttribute("obj"); // 로그인시 obj이름으로 세션생성했음
		profiledto.setUserid(userdto.getUserid()); // 프로필 입력 아이디 셋팅
