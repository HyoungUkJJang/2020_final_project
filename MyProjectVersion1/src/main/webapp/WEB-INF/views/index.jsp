							...
							<form action="./login" method="post">
                                ...
                                <br>
                                    <div class="field half">
										...
										<input type="password" name="userpwd" id="pwd" value=""/><br>
									</div>
									
								<button type="submit" class="button big wide" >Login</button>
				        	 	<button type="button" class="button big wide"  data-toggle="modal" data-target="#exampleModalLong" >Join</button>  
